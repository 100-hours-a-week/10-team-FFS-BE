 ...
 * @param uploadSlots VTON용 이미지 URL 목록 (nullable)
 * @param timestamp 요청 시각 (ISO 8601)
 */
public record OutfitKafkaRequest(
        String requestId, Long userId, String query, String sessionId, List<String> uploadSlots, String timestamp) {

    // TODO: AI 팀 협의 후 추가 예정 필드: turnNo, prevTurnNo, prevResultId, prevReaction

    public static OutfitKafkaRequest of(
            String requestId, Long userId, String query, String sessionId, List<String> uploadSlots) {
